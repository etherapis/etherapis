...
var contractAddress = common.HexToAddress("0xf8c02c76cbc62817c1d5349a83fa5febb6238338")
...
type Contract struct {
	abi     abi.ABI
	stateFn func() (*state.StateDB, error)
...
func GetContract(db ethdb.Database, mux *event.TypeMux, stateFn func() (*state.StateDB, error)) (*Contract, error) {
	contract := Contract{
		stateFn: stateFn,
